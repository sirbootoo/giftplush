...
var routes = [
    ...
    { path: 'wishlist', component: index_1.WishlistComponent,
        children: [
            ...
            { path: 'preview', component: index_1.WishlistPreviewComponent },
            { path: 'share', component: index_1.ShareWishlistComponent },
            { path: 'index', component: index_1.WishlistSelectVoucherComponent }
        ]
    },
