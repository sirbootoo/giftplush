...
var WishlistSelectVoucherComponent = (function () {
    function WishlistSelectVoucherComponent(meta, title, wishlistService, productService, pubSubService, algoliaService, el, renderer) {
    ...
    //     return el;
    // }
    WishlistSelectVoucherComponent.prototype.remove = function (id) {
        this.wishlistService.delete(id);
        this.loadList();
    };
    WishlistSelectVoucherComponent.prototype.loadList = function () {
