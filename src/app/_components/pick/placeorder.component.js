...
var PlaceOrderComponent = (function () {
    function PlaceOrderComponent(route, algoliaService, router) {
        var _this = this;
        this.route = route;
        ...
        this.route.data.subscribe(function (data) {
            ...
            _this.info.claimBefore = new Date(data.info.claimBefore).toUTCString();
            console.log(_this.info.claimBefore);
        });
    }
    PlaceOrderComponent.prototype.back = function () {
        this.router.navigate(['/messagepreview']);
    };
    PlaceOrderComponent.prototype.proceed = function () {
        console.log('lol');
    };
